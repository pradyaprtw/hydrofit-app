...
<x-app-layout>
    ...
    <div class="min-h-screen bg-white pb-24 font-sans relative overflow-x-hidden">
        
        {{-- === SIDEBAR DRAWER (MENU SAMPING) === --}}
        
        {{-- 1. Overlay Gelap (Background) --}}
        ...
        <div id="sidebar-drawer" class="fixed inset-y-0 left-0 w-64 bg-white z-50 transform -translate-x-full transition-transform duration-300 ease-in-out shadow-2xl flex flex-col justify-between">
            ...
            <div class="p-6">
                ...
                <nav>
                    ...
                    {{-- Tambah menu lain di sini kalau mau --}}
                </nav>
            </div>
        ...
        <div class="px-6 mt-4 text-center">
            <h2 class="text-xl font-bold text-gray-900 leading-tight">HydroFit - Pantau Cairan Tubuhmu!</h2>
            <p class="text-gray-400 text-sm mt-2 mb-8">Halo, {{ Auth::user()->name ?? 'Teman' }}! Yuk cek hidrasi kamu hari ini</p>

            <div class="space-y-4">
                {{-- Menu Hitung --}}
                <a href="{{ route('calculate') }}" class="flex items-center px-4 py-3 text-white rounded-lg shadow-sm cursor-pointer transition transform active:scale-95" style="background-color: #40B7D5;">
                    <svg style="width: 24px; height: 24px; margin-right: 12px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                    <span class="font-bold text-lg">Hitung Kebutuhan Air</span>
                </a>
                {{-- Menu Pengingat --}}
                <a href="{{ route('reminder') }}" class="flex items-center px-4 py-3 text-white rounded-lg shadow-sm cursor-pointer transition transform active:scale-95" style="background-color: #40B7D5;">
                    <svg style="width: 24px; height: 24px; margin-right: 12px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
                    <span class="font-bold text-lg">Pengingat Minum</span>
                </a>
                {{-- Menu Edukasi --}}
                <a href="{{ route('education.index') }}" class="flex items-center px-4 py-3 text-white rounded-lg shadow-sm cursor-pointer transition transform active:scale-95" style="background-color: #40B7D5;">
                    <svg style="width: 24px; height: 24px; margin-right: 12px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                    <span class="font-bold text-lg">Edukasi Singkat</span>
                </a>
                {{-- Banner --}}
                <div class="mt-8 p-4 rounded-xl flex items-center shadow-sm" style="background-color: #FFF8E1;">
                    <svg style="width: 30px; height: 30px; color: #D97706; margin-right: 10px;" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clip-rule="evenodd"></path></svg>
                    <span class="font-semibold text-sm text-left" style="color: #B45309;">Minum cukup = performa maksimal</span>
                </div>
            </div>
        </div>
